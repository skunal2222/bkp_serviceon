...
class SlotLib {
	...
	public function addVslot($cat) {
		$this->CI->load->model ( 'api/slot/Slot_model', 'slotmodel' );
	...
	public function getActiveVisiting() {
		...
		return $response;
	}	public function getActiveVisiting1() {			$this->CI->load->model ( 'slot/Slot_model', 'slotmodel' );			$response = $this->CI->slotmodel->getActiveVisiting1();			return $response;		}
