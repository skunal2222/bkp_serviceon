...
class General {
	...
	public function addCategory($cat) {
		...
		$this->CI->load->model ( 'api/general/Settings_model', 'settings');
	...
	public function getAreaidandCityidByRestaurant($a) {
		$this->CI->load->model ( 'api/coupan/Coupan_model', 'coupon' );
	...
	public function add_user_vehicle_license($params) {

		echo "<pre>";
		print_r($params);
		exit();
		$this->CI->load->model ( 'api/general/Settings_model', 'settings' );
		$response = $this->CI->settings->add_user_vehicle_license ($params);
		return $response;
	}
}
