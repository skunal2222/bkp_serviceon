												...
												<tbody>
													...
													<tr>
														<td	style="color: #000; font-size: 16px; padding-bottom: 7px; font-family: Arial;">
														    Given below is the link to reset password of your BikeDoctor account</td>
													</tr>
													...
													<tr>
														<td style="color:#000;font-size:16px;padding-bottom:7px;font-family:Arial;">
															 <a href="<?php echo base_url();?>resetPassword/<?php echo $data['id'];?>/<?php echo $data['reset_code'];?>" target="_blank"><?php echo base_url();?>resetPassword/<?php echo $data['id'];?>/<?php echo $data['reset_code'];?></a>
														</td>
													</tr>
													<tr>
														<td style="color:#000;font-size:16px;padding-bottom:7px;font-family:Arial;">
															 Please do not share your login details with anyone to prevent misuse.
														</td>
													</tr>
													<tr>													
														<td style="color:#000;font-size:16px;padding-bottom:17px;font-family:Arial;">Thanks! <br> <?php echo COMPANY ?> Team</td>
													</tr>
												</tbody>
											</table>
										</td>
