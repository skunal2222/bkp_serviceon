										...
										<td valign="top style=padding: 0px 13px 10px 14px;font-family:Arial">
											<table width="100% cellspacing=0 cellpadding=0">
												...
												<?php $name = explode(" ",$data['name']);
													...
													<tr>
														<td>
															<table style="width:100%;" cellspacing="0">
																...
																<tr class="items">
																	<td style="border-left:1px solid #212121;border-top:1px solid #212121;font-size:16px;font-family:Arial;"><b>Service</b></td>
													...
													<tr>
														<td style="color:#000;font-size:16px;font-family:Arial;padding-bottom:14px;">
															We will keep you updated as soon as your vehicle is ready for delivery. <br><br>
														</td>
													</tr>
													<tr>
														<td style="color:#000;font-size:16px;font-family:Arial;padding-bottom:19px;">
															Have a fantastic day! <br><br><?php echo COMPANY; ?> Team
														</td>
													</tr>
												</tbody>
											</table>
