...
<div class="booking jumbotron">
	<div class="container">
		...
		<div class="confirm text-center">
			<h3>Do you wish to add Packages?</h3><br/>
			<button type="button" class="custom-btn1" onclick="window.location.href = '<?php echo base_url();?>select-package';">Continue</button>
		</div>
	</div>
</div>