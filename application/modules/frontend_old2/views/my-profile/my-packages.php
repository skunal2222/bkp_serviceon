				...
				<div class="detail-section">
					...
					<div class="col-sm-6 col-md-4 col-xs-12">
						<div class="package text-center">
							...
							<h4> Rs <strike> <?php echo $item['best_price'];?></strike></h4>
							<h4>Offer Rs <?php echo $item['special_price'];?></h4>
						  <!--  <?php  foreach ($item['services'] as $services): ?>
							...
							<button type="button" class="custom-btn1" onclick="setPackage(<?php echo $item['id'];?>)">Buy Now</button>
							<?php else  : ?>
								 ...
								 if($package['is_expire']!=0 && $package['ordercnt'] < $package['service_used_validity'] && $expiredate > $currentdate )
									...
									<div class="col-md-3 col-sm-3 text-right">
										...
										<div class="button-sec">
											...
											<?php } elseif ($pkstatus=='InActive') { ?>
												
												<button type="button" class="spl-btn" style="font-size: 12px; line-height: 2;" onclick="place_order(<?= $packageinfo['id'] ?>);">Package InActive</button>
											...
											<a href="<?php echo base_url().$package['invoice_url']; ?> "  target="_blank" > Download Invoice</a>
										</div>
							</div>
						</div>
