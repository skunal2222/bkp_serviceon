<div class="terms">
  <!-- This agreement can also be known under these names: starts-->
   ...
   <div class="bann">
     ...
     <p class="spl-p">Surprise your Bike with Pune's Expert mechanic!<br/> Fill the form below to get a quote!</p>
     </div>
   ...
   <div class="contactus">
       <div class="contact-form con text-center">
              <h3>We deliver perfect!</h3>
                <form class="custom-form" action="<?php echo base_url();?>frontend/getquote" method="post" action="" id="partnerwithus" novalidate="novalidate">
