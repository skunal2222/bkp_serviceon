				...
				<div class="detail-section">
                            ...
                            <div class="order-status panel-collapse collapse in" id="collapse1">
                                  <div class="order-spl">
                                    <ul class="nav nav-pills spl-navbar">
                                        ...
                                        <li><a data-toggle="pill" href="#track"><span>Track</span></a></li>
                                    </ul>
                                    <div class="tab-content">
                                        ...
                                        <div id="track" class="tab-pane fade">
                                          <div class="track-spl">
                                            <div class="box1">
                                                <div class="timeline">
                                                    <div class="timeline-right white">
                                                        <div class="img done"></div>
                                                        <div class="content top">
                                                            <p class="green1">Booking Status</p>
                                                            <p class="green2">Date, Time</p>
                                                        </div>
                                                    </div>
                            ...
                            <div class="order-status panel-collapse collapse" id="collapse2">
                                <div class="order-spl">
                                    <ul class="nav nav-pills spl-navbar">
                                        ...
                                        <li><a data-toggle="pill" href="#track2"><span>Track</span></a></li>
                                    </ul>
                                    <div class="tab-content">
                    ...
                    <!-- no ongoing orders ends -->
						<div class="no-ongoing-orders">
	  						...
	  						<h3>You have no upcoming booking till now!</h3>
	  						<button type="button" class="saved-btn">Book Now</button>
						</div>
					<!-- no ongoing orders ends -->
