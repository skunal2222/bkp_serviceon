<link href="<?php echo asset_url();?>frontend/css/my-profile/ongoing-orders.css" rel="stylesheet"><link rel="stylesheet" type="text/css" href="<?php echo asset_url();?>frontend/css/my-profile/common.css">
<div class="my-pofile">
    <div class="container">
  ...
  <!-- Ongoing Order  -->
          ...
          <?php $i++; ?>
                        <div class="ongoingorder">
                            ...
                            <div class="order-status panel-collapse collapse in" id="collapse<?php echo $order['orderid']?>">
                                  <div class="order-spl">
                                                  ...
                                                  <div class="total-bill">
                                                    <div class="row">
                                                         ...
                                                         <div class="col-sm-6 col-md-3 col-xs-5">
                                                             <a href="<?php echo base_url().$order['invoice_url']; ?>" target="_blank"><button type="button" class="download-btn">Download Invoice</button></a>
                                                          </div>
