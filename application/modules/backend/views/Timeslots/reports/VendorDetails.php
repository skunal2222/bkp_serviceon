               		   ...
               		   <div class="row" style="width: 70%;">
		                    ...
		                    <div class="col-md-6">
		                        ...
		                        Spare Commission : <b><?php echo $vendors[0]['commission_spare'];?>%</b><br>
		                       	...
		                       	G2G Service Commission : <b><?php echo $g2gservicecommission;?></b><br>
		                       	Vendor service Commission : <b><?php echo $vendorservicecommission;?></b><br>
		                       	G2G Spare Commission : <b><?php echo $g2gsparecommission;?></b><br>
	              	...
	              	<table id="example1" class="display" cellspacing="0" width="100%">
				        <thead class="bg-info">
				        	<tr>
				                ...
				                <th>G2G Service Commission</th>
				                <th>Vendor Service Commission</th>
				                <th>G2G Spare Commission</th>
