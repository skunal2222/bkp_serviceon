<div id="page-wrapper">
	<div class="container-fluid">
		...
		<form id="addservicegroup" name="addservicegroup" action="" method="post" enctype="multipart/form-data">
...
<script>
$('#addservicegroup').bootstrapValidator({
...
function addservicegroup() {
	var options = {
	 		...
	 		url : base_url+'admin/staticservicegroup/add',
	 		semantic : true,
	 		dataType : 'json'
	 	};
   	$('#addservicegroup').ajaxSubmit(options);
}
