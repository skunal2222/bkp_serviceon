<div id="page-wrapper">
	<div class="container-fluid">
		...
		<form id="editsubcategory" name="editsubcategory" action="" method="post" enctype="multipart/form-data">
...
<script>
$('#editsubcategory').bootstrapValidator({
...
function editsubcategory() {
	var options = {
	 		...
	 		url : base_url+'admin/staticsubcategory/update',
	 		semantic : true,
	 		dataType : 'json'
	 	};
...
function showAddResponse(resp, statusText, xhr, $form){
	if(resp.status == '0') {
        ...
        $("#response").show();
        alert(resp.msg);
        window.location.href = base_url+"admin/staticsubcategory/list";
  	}
}
</script>