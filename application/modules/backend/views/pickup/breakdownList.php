<div id="page-wrapper">
	...
	<div class="row">
		...
		<div class="col-lg-12">
			...
			<a href="<?php echo base_url();?>admin/general/adddrop" class="btn btn-primary view-contacts bottom-margin" >
				<i class="fa fa-plus"></i> Breakdown Slot
			</a>
                	...
                	<div class="dataTable_wrapper">
                       	<table class="table table-striped table-bordered table-hover" id="tblRestos">
							...
							<?php foreach ($breakdown as $item):?>
								<tr>
									<td>
										<a href="<?= base_url('admin/general/editBreakdown/').$item['id']?>"><?= $item['id'];?></a>
									</td>
									<td>
										<?php echo $item['minkm'];?>
									</td>
