...
<div class="row" style="padding-left: 259px;padding-right: 35px;">
	<div class="col-lg-12">
		<h3 class="page-header">Add BreakDown slot</h3>
		<div class="panel panel-info">
			<div class="panel-wrapper collapse in" aria-expanded="true">
				<div class="panel-body">
					<div class="form-body">		

						<form id="addrestaurant" name="addrestaurant" action="<?= base_url('admin/pickup/insertDropdown')?>" method="post">
							<div class="row">
								<div class="col-lg-12">
											...
											<div class="row">
												<div class="col-lg-6 margin-bottom-5">
													<div class="form-group" id="error-name">
														...
														<div class="col-sm-10">
															<input type="text" autocomplete="off" class="form-control" id="garage_name" name="minkm"/>
														</div>
												...
												<div class="col-lg-6 margin-bottom-5">
													<div class="form-group" id="error-name">
														...
														<div class="col-sm-10">
															<input type="text" class="form-control" id="name" name="maxkm"/>
														</div>
														<div class="messageContainer col-sm-10"></div>
													</div>
												</div>
											...
											<div class="row">
												<div class="col-lg-6 margin-bottom-5">
													<div class="form-group" id="error-landmark">
														...
														<div class="col-sm-10">
															<input type="text" class="form-control" id="email" name="price" autocomplete="off"/>
														</div>
														<div class="messageContainer col-sm-10"></div>
													</div>
												</div>
	...
	$('#addrestaurant').bootstrapValidator({
		...
		$.ajax({
			...
			success: function(data)
			{
				...
				if(data.status == '1'){
					alert(data.msg);
					window.location.href = base_url+"admin/general/breakdown";
				}
			}
		});
