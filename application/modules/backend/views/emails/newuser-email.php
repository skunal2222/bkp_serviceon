					...
					<tr>
						<td>
							<table
								...
								<tbody>
									<tr>
										<td valign="top"><a href="<?php echo base_url();?>"> <img
												src="<?php echo asset_url();?>/images/img/Logo.png"
												...
												<tbody>
													...
													<tr>
														<td	style="color: #000; font-size: 16px; padding-bottom: 7px; font-family: Arial;">
														  Your Username and password to access your admin panel</td>
													</tr>
													<tr>														
														<td style="color:#666666;font-size:16px;padding-bottom:17px;font-family:Calibri,sans-serif;font-weight:300;font-weight:2;">	
																<a href="<?php echo base_url();?>/client" target="_blank">Login Url</a>
														</td>
													</tr>
													<tr>
														<td style="color: #000; font-size: 16px; padding-bottom: 7px; font-family: Arial;">		
															Username : <?php echo $data['email'];?>   <br />					
															Password : <?php echo $data['text_password'];?> </td>
													</tr>
													<tr>
														<td
