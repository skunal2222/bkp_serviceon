	...
	<div class="row">
        	<div class="panel panel-default">
            	<div class="panel-heading">
                	<span style="cursor:pointer;" onclick="hideNav();" id="show-hide-nav"><i class="fa fa-chevron-circle-left fa-2x"></i></span> Orders for Pickup
              	</div>
              	<div>
              		<form action="<?php echo base_url();?>crm/order/pickuporders" method="post">
              		<div class="panel panel-default">
