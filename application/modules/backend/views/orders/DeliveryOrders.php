	...
	<div class="row">
        	<div class="panel panel-default">
            	<div class="panel-heading">
                	<span style="cursor:pointer;" onclick="hideNav();" id="show-hide-nav"><i class="fa fa-chevron-circle-left fa-2x"></i></span> Orders For Delivery
              	</div>
              	<div>
	              	<form action="<?php echo base_url();?>crm/order/deliveryorders" method="post">
	              		<div class="panel panel-default">
		                   	<div class="panel-body">
	                            <div class="row">
		                            <div class="col-sm-3">
		                            	<input type="text" id="delivery_date" name="delivery_date" class="form-control" placeholder="Delivery Date"/>
		                            </div>
		                            <div class="col-sm-3">
                       	...
                       	<table class="table table-striped table-bordered table-hover" id="tblRestos">
							...
							<?php foreach ($orders as $item):?>
								<tr>
									...
									<td>
										<?php echo date('j M Y',strtotime($item['tml_delivery_date']));?>
									</td>
									<td>
										<?php echo $item['delivery_slot'];?>
									</td>
									<td>
										<?php echo $item['delivery_executive_name'];?>
									</td>
								</tr>
								<?php endforeach;?>
							<?php }?>
