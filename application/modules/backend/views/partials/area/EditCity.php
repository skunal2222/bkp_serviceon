								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<div class="form-group" id="error-name">
											...
											<input type="text" class="form-control" value="<?php echo $cities[0]['name'];?>" id="name" name="name" />
									...
									<div class="col-md-6">
										...
										<div class="form-group" id="error-name">
											...
											<select id="status" class="form-control" name="status">
												...
												<option value="1" <?php if(isset($cities[0]['status']) && $cities[0]['status'] == 1) {?>selected<?php }?>>Enable</option>

												<option value="0" <?php if(isset($cities[0]['status']) && $cities[0]['status'] == 0) {?>selected<?php }?>>Disable</option>
...
function updateCategory() {
	...
	var options = {
	 		...
	 		url : base_url+'client/city/update',
...
function showAddResponse(resp, statusText, xhr, $form){
	...
	if(resp.status == '0') {
        ...
        window.location.href = base_url+"client/mainarea";
