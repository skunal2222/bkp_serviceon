                                                            ...
                                                            <form onsubmit="return add_invoice(this);">
                                                                <tbody>
                                                                    <tr class="c-table__row">
                                                                        ...
                                                                        <td class="c-table__cell"><?= $row['garage_name']; ?></td>
                                                                <input type="hidden" name="vendor_id" value="<?= $row['vendor_id'] ?>">
                                                                <input type="hidden" name="vendor_name" value="<?= $row['garage_name']; ?>">
                                                                ...
                                                                <td class="c-table__cell">
                                                                    <?= isset($row['online_spare_total'])? $row['online_spare_total']:0;
                                                                    ?>
                                                                </td>
