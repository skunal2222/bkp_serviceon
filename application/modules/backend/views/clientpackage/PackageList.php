...
<div id="page-wrapper">
	<div class="row" >
		...
		<div class="col-lg-12" style="padding:0px">
			<div class="btn-plus">
			<a href="<?php echo base_url();?>client/package/addpackage" class="btn btn-primary view-contacts bottom-margin">
					...
					<table class="table table-striped table-bordered table-hover" id="tblCity">	<thead class="bg-info">
							...
							<?php if (isset($package)) { ?>
								...
								<tr>
							        ...
							        <td><a href = "<?php echo base_url();?>client/package/update/<?php echo $item['id'];?>" class="btn btn-success icon-btn btn-xs"><i class="fa fa-pencil"></i></a>
                                    </td>
