          ...
          <div class="col-lg-12">
                ...
                <div class="row">
                  <div class="col-lg-6 margin-bottom-5">
                    <div class="form-group" id="error-mstart_time">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="packagename" name="name" value="<?php echo $packageItem['package_name']; ?>" required />
                      </div>
            ...
            <select name="model_id[]" id="model_id" class="form-control" multiple="true">
                ...
                <?php foreach ($models as $model) {
                      foreach ($packagemodels as $value) {
            ...
            <input type="button" id="select_all2" class="btn btn-success" name="select_all2" value="Select All">  <input type="button" class="btn btn-success" id="model_clear_all" name="model_clear_all" value="Clear All">
            </div>
            </div>
                  ...
                  <option value=""> Select Subcategory</option>  
                   <?php
                        ...
                        <option value="<?php echo $subcat['id'] ?>"
                                <?php if (in_array($subcat['id'], $commaseparatedlist))  {?>
                        selected 
                        <?php }?>>
            ...
            <div class="col-lg-6 margin-bottom-5">
              <div class="form-group" id="error-name">
                <label class="control-label col-sm-5">Select Services </label>
                  <div class="col-sm-10">
                <select name="service_id[]" id="service_id" class="form-control" multiple="true">   <option value=""> Select Services</option> 
...
function updatePackage(){
	...
	var options = {
	 		...
	 		url : base_url+'client/package/updatePackage',
	 		semantic : true,
	 		dataType : 'json'
	 	};
...
function showAddResponse(resp, statusText, xhr, $form){
	if(resp.status == '0') {
        ...
        $("#response").show();
        alert(resp.msg);
        window.location.href = base_url+"client/package/list";
  	}
}
</script>
	...
	$("#category_id").change(function() {
       ...
       $("#brand_id").change(function() {
        ...
        $("#subcategory_id").change(function() {
                ...
                $.post(base_url+"admin/servicebycatid3/", {subcat_id : subcat_id}, function(data)
                {
                //$('#service_id').empty();
                if(data.length > 0)
                {           
    ...
    function generate_estimate() {
        ...
        $( "#packagename" ).change(function() {
           var package_name = $('#packagename').val();
            $.post(base_url + "client/package/packagenameexist", {
