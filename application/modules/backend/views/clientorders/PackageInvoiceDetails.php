		...
		<td>
			<table style="width:100%;" class="print-friendly">
			  <tr>
					...
					<td style="padding-right: 25px;"> &nbsp;<?php echo $order['order_id'];?></td>
				</tr> 
				
                                <tr>
					<td style="width:13%;">Client</td>
					<td> &nbsp;<?php echo $order['first_name'].$order['last_name']; ?></td>  
				</tr>
                                <tr>
					<td style="width:13%;">Outlet</td>
					<td> &nbsp;<?php echo $order['outlet_name']; ?></td>  
				</tr>
                                <tr>
					<td style="width:13%;">Bike</td>
					<td> &nbsp; <?php echo $order['bike_name']; ?> -  <?php echo $order['bike_number']; ?></td>  
				</tr>
			...
			<table style="width:100%;"  cellspacing="0" class="print-friendly">
				<tr class="items"> 
					<td style="border-left:1px solid #212121;border-top:1px solid #212121;text-align:center;"><b>Package Name</b></td>
	 				<td style="border-top:1px solid #212121;text-align:center;"><b><?php echo $packageData[0]['package_name']; ?></b></td> 
				</tr>
				<tr class="items">
				...
				<tr class="items">
					<td style="border-left:1px solid #212121;border-top:1px solid #212121;text-align:center;"><b>Special package amount</b></td>
 					<td style="border-top:1px solid #212121;text-align:center;"><b>RS.<?php echo $packageData[0]['special_price']; ?></b></td>
				</tr>
			</table>
		</td>
	</tr>
