	...
	<div class="row">
        	<div class="panel panel-default" style="width: 100%;">
            	<div class="panel-heading">
                	<span style="cursor:pointer;" onclick="hideNav();" id="show-hide-nav"><i class="fa fa-chevron-circle-left fa-2x"></i></span> Completed Orders
              	</div>
              	<div>
              		<form action="<?php echo base_url();?>crm/order/completedorders" method="post">
                	...
                	<div class="dataTable_wrapper" style="overflow:auto;">
							...
							<?php foreach ($orders as $item):?>
								...
								<!-- 	<td><input type="checkbox" name="orderid[]" class="orderid" value="<?php echo $item['order_id'];?>"/></td> -->
									...
									<!-- <td>
										<a href = "<?php echo base_url();?>client/order/view_details/<?php echo $item['order_id']?>" class="btn btn-success icon-btn btn-xs">Process</a>
									</td>-->
								</tr>
								<?php endforeach;?>
							<?php }?>
