...
<div id="page-wrapper">
	...
	<div class="row">
		...
		<div class="col-lg-12">
			...
			<a href="<?php echo base_url();?>admin/vendor/new" class="btn btn-primary view-contacts bottom-margin" >
                       	...
                       	<table class="table table-striped table-bordered table-hover" id="tblRestos">
							...
							<?php foreach ($restaurants as $item):?>
								...
								<!-- 	<td>
									...
									<td><a href = "<?php echo base_url();?>admin/vendor/VendorEdit_trial/<?php echo $item['id']?>" class="btn btn-success icon-btn btn-xs"><i class="fa fa-pencil"></i></a></td>
								</tr>
								<?php endforeach;?>
							<?php } else { ?>
