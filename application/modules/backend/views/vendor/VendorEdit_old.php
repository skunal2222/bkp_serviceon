...
<div id="response"></div>
							...
							<div class="panel panel-default">
								<div class="panel-body">
									<div class="row">
										<div class="col-lg-6 margin-bottom-5">
											<div class="form-group" id="error-name">
												<label class="control-label col-sm-5">Mechanic Name <span
									...
									<div class="row">
										<div class="col-lg-6 margin-bottom-5">
											<div class="form-group" id="error-name">
												<label class="control-label col-sm-5">Category<span
													class='text-danger'>*</span></label>
												<div class="col-sm-10">
										...
										<div class="col-lg-6 margin-bottom-5">
											<div class="form-group" id="error-name">
												...
												<div class="col-sm-10">
													...
													<input type="button" class="btn btn-success" id="select_all" name="select_all" value="Select All">
								...
								<div class="row">
									...
									<div class="col-lg-6 margin-bottom-5">
										<div class="form-group" id="error-locality">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" id="locality" name="locality" value="<?php if(isset($basic[0]['locality'])) echo $basic[0]['locality'];?>"    />
											</div>
											<div class="messageContainer col-sm-10"></div>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-lg-6 margin-bottom-5">
										<div class="form-group" id="error-longitude">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" id="latitude" name="latitude" value="<?php echo $basic[0]['latitude'];?>" readonly    />
											</div>
											<div class="messageContainer col-sm-10"></div>
										</div>
									</div>
									<div class="col-lg-6 margin-bottom-5">
										<div class="form-group" id="error-longitude">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" id="longitude" name="longitude"	value="<?php echo $basic[0]['longitude'];?>" readonly  />
											</div>
											<div class="messageContainer col-sm-10"></div>
										</div>
									</div>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="panel panel-default">
											...
											<div class="form-group" id="error-company_name">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" id="company_name"
														name="company_name"
														value="<?php if(isset($bconfig[0]['company_name'])) echo $bconfig[0]['company_name'];?>" />
												</div>
												<div class="messageContainer col-sm-10"></div>
											</div>
										</div>
												...
												<div class="form-group" id="error-cheque-favour-of">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control"
															...
															value="<?php if(isset($bconfig[0]['cheque_favour_of'])) echo $bconfig[0]['cheque_favour_of'];?>" />
													</div>
													<div class="messageContainer col-sm-10"></div>
												</div>
											</div>
										...
										<div class="row">
											...
											<div class="col-lg-6 margin-bottom-5">
												<div class="form-group" id="error-ifsc_code">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" placeholder="(e.g SBIN1234567)" id="ifsc_code"
															name="ifsc_code"
											...
											<div class="form-group" id="error-min_amount">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" id="wallet_name"
														name="wallet_name" value="<?php if(isset($bconfig[0]['wallet_name'])) echo $bconfig[0]['wallet_name'];?>" />
												</div>
												<div class="messageContainer col-sm-10"></div>
											</div>
										</div>
											...
											<div class="form-group" id="error-min_amount">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" id="mob_no"
														name="mob_no" value="<?php if(isset($bconfig[0]['mob_no'])) echo $bconfig[0]['mob_no'];?>" />
												</div>
												<div class="messageContainer col-sm-10"></div>
											</div>
										</div> -->
								...
								<button type="submit" class="btn btn-success" disabled>Update</button>
								<?php } ?>
											<button class="btn btn-success" data-toggle="collapse" data-target="#collapseFive" aria-expanded="true" aria-controls="collapseFive">Next</button>
    ...
    <div class="panel panel-default"><a data-toggle="collapse" data-parent="#accordion" onclick="initMap();" data-target="#collapseFive">
    <div class="panel-heading" style="background-color:#ccc;">
...
$.getScript("https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places,drawing&callback=initMap&key=AIzaSyDg0MeuSys4bB3W0ji2VsMUjc6kJDkfjZk"); 
...
function initMap() {
	...
	autocomplete.addListener('place_changed', function() {
	    ...
	    console.log(place.geometry.locality);
	    $('#latitude').val(place.geometry.locality.lat());
	    $('#longitude').val(place.geometry.locality.lng());
...
function displayMap() {
	...
	if(is_map_loaded == 0) {
		map = new google.maps.Map(document.getElementById('map-canvas'), {
		      zoom: 13,
		      center: new google.maps.LatLng( <?php if($basic[0]['latitude'] != '') echo $basic[0]['latitude']; else echo 0;?> , <?php if($basic[0]['longitude'] != '') echo $basic[0]['longitude'];  else echo 0 ; ?> ),
		    ...
		    var marker = new google.maps.Marker({
			    position: new google.maps.LatLng( <?php if($basic[0]['latitude'] != '') echo $basic[0]['latitude']; else echo 0;?> , <?php if($basic[0]['longitude'] != '') echo $basic[0]['longitude'];  else echo 0 ; ?>),
			    map: map,
			    draggable:true,
			...
			map.controls[google.maps.ControlPosition.TOP_RIGHT].push(deleteControlDiv);
		    	...
		    	<?php if (count($coords) > 0) { ?>
					...
					<?php if(!empty($coord['latitude']) && !empty($coord['longitude'])) { ?>
						...
						lats.push(new google.maps.LatLng(<?php if($coord[0]['latitude'] != '') echo $coord[0]['latitude']; else echo 0;?> , <?php if($coord[0]['longitude'] != '') echo $coord[0]['longitude'];  else echo 0 ; ?>
							));
		    		<?php } ?>
					<?php } ?>
		        ...
		        <?php } else { ?>
		        	var lat =  <?php if($basic[0]['latitude'] != '') echo $basic[0]['latitude']; else echo 0;?>  ;
		        	var lng = <?php if($basic[0]['longitude'] != '') echo $basic[0]['longitude']; else echo 0;?>;
